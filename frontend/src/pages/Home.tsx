...
export const Home = () => {
  const { isAuthenticated, user, clearAuth, setUser, openLoginModal } =
    useAuthStore();
  ...
  const [latestJobRole, setLatestJobRole] = useState<string | undefined>(
    undefined,
  );
  ...
  const resumeSlides = [
    {
      ...
      title: "AIWORK 가이드 봇",
      description:
        "채팅으로 요청하면 필요한 기능을 바로 실행하고 상황에 맞는 다음 작업까지 에이전트처럼 이어서 처리합니다.",
      badge: "Agent Mode",
    },
    {
      ...
      title: "스마트 이력서 분석",
      description:
        "이력서를 업로드하면 AI가 강점과 보완점을 분석하고 맞춤형 면접을 준비해 줍니다.",
      ...
      <main className="dashboard-container">
        <div className="dashboard-left">
          <div className="dashboard-card search-card">
            <h2>
              당신의 커리어를 <span className="highlight">가속화할</span> 기회
            </h2>
        ...
        <div className="dashboard-right">
          ...
          <div
            ...
            style={{
              cursor: user?.github_url && !isEditingGithub ? "pointer" : "default",
            }}
            onClick={() => {
          ...
          >
            ...
            <div className="card-content">
              <h4>Discord 봇 추가</h4>
              <p>
                디스코드 환경에서도 AI 자소서와 채용 조언을 실시간으로 받아보실
                수 있습니다.
              </p>
            </div>
          </div>
